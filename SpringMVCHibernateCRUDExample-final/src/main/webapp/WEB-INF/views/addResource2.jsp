...
<body>
	...
	<form method="post" name = "success" modelAttribute="resource" action="/SpringMVCHibernateCRUDExample/success">
		...
		<table align="center" cellpadding="10">
		 ...
		 <tr>
			...
			<tr>
				...
				<br />
				<br /></td>
				<td><textarea name="primarySkill" rows="10" cols="60" required>
        </textarea></td>
			</tr>
			...
			<tr>
				...
				<td>Desirable Skills:<br />
				<br />
				<br />
				<br />
				<br />
				<br /></td>
				<td><textarea name="desirableSkill" rows="7" cols="60" required>
        </textarea></td>
			</tr>
			...
			<tr>
				...
				<td><h4>Planned Roles and Responsibilities:</h4></td>
			</tr>
			<tr>
				<td>Need to work at John Deere Project:</td>
				<td><input type="text" name="rolesAndResponsibilities" required />
			...
			<tr>
				...
				<td><input type="text" name="targetCompany" required /></td>
			</tr>

				<!-------- Career Growth Plan  ----------->
			<tr>
				<td>Career Growth Plan:</td>
				<td><input type="text" name="growthPlan" required /></td>
			</tr>
			<!-------- Key scanners  ----------->
			<tr>
				<td>Key scanners:</td>
				<td><input type="text" name="keyScanners" required /></td>
			</tr>
			<tr>
			...
			<tr>
				<td>1st Round :</td>
				<td><input type="text" name="firstInterview" required />
			</tr>
			<tr>
				<td>2nd Round :</td>
				<td><input type="text" name="secondInterview" required /></td>
			</tr>
			<!-----	--- Additional comments, if any --------------->
			<tr>

				<td>Additional comments, if any:<br />
				<br />
				<br />
				<br />
				<br />
				<br /></td>
				<td><textarea name="comments" rows="7" cols="60" required>
        </textarea></td>
			</tr> 
			...
			<tr>
				<td colspan="2" align="center"><input type="submit"
					class="btnLogin" name="success" value="Submit" tabindex="4"> <input
					type="reset" class="btnLogin" value="Reset"></td>
