	...
	<c:if test="${!empty listOfResources}">
		<table border= "2" width="70%" cellpadding="2">
			...
			<c:forEach items="${listOfResources}" var="resources">
				<tr>
					<td align = "center">${resources.reqId}</td>
					<td align = "center">${resources.requestingPractice}</td>
					<td align = "center">${resources.lineOfBusiness}</td>
					<td align = "center"><a href="<c:url value='/viewResource/${resources.reqId}' />">view</a></td>
